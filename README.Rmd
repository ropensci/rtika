...
[![Travis-CI Build Status](https://travis-ci.com/ropensci/rtika.svg?branch=master)](https://travis-ci.com/ropensci/rtika)
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/ropensci/rtika?branch=master&svg=true)](https://ci.appveyor.com/project/goodmansasha/rtika)
